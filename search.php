...
<?php
 if(isset($_POST["submit"])&& (!empty($_POST['brand']) ||!empty($_POST['color']))){
  ...
  $sql="SELECT * from products where Color='".$_POST['color']."'AND Name LIKE '%".$_GET["Key"]."%' OR Brand LIKE '%".$_GET["Key"]."%' ";
       }
       else  if(!empty($_POST['brand'])&& empty($_POST['color'])){
         $sql="SELECT * from products where Brand='".$_POST['brand']."'AND Name LIKE '%".$_GET["Key"]."%' OR Brand LIKE '%".$_GET["Key"]."%'";
       }
       else if(!empty($_POST["brand"])&& !empty($_POST["color"])){
         $sql="SELECT * from products where Brand='".$_POST['brand']."' AND Color='".$_POST['color']."' AND Name LIKE '%".$_GET["Key"]."%' OR Brand LIKE '%".$_GET["Key"]."%'";
       }
         }
         

 else $sql="SELECT * from products where Name LIKE '%".$_GET["Key"]."%' OR Brand LIKE '%".$_GET["Key"]."%'";
